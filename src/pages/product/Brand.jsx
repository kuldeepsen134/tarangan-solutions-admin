...
import { brandsList } from "../../redux/slice/brand.slice";

const BrandPage = () => {
  const [editCategory, seteditCategory] = useState("");

  const { brandListData, brandData } = useSelector((state) => state.brands);
  ...
  const formikEditCategory = useFormik({
    initialValues: {
      ...
      originCountry: brandData.originCountry || "",
    },
    enableReinitialize: true,
                        ...
                        <tr key={brand._id}>
                          ...
                          <td>
                            <button
                              ...
                              onClick={() => seteditCategory(brand?._id)}
                            >
                              Edit
                            </button>
                            <button
                              type="button"
                              onClick={() =>
                                handleDeleteCategories(brand._id)
                              }
